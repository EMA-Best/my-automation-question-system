...
function buildTemplateDesc(doc) {
    var title = typeof doc.title === 'string' ? doc.title.trim() : '';
    if (title)
        return "\u8FD9\u662F\u5173\u4E8E\u300A" + title + "\u300B\u7684\u95EE\u5377\u6A21\u677F";
    return '这是一个问卷模板';
}
function main() {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var host, port, database, uri, db, templates, filter, targets, now, ops, result;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, templates.find(filter).toArray()];
                case 2:
                    targets = _e.sent();
                    if (!(targets.length === 0)) return [3 /*break*/, 4];
                ...
                case 4:
                    now = new Date();
                    ops = targets.map(function (doc) { return ({
                        updateOne: {
                            filter: { _id: doc._id },
                            update: {
                                $set: {
                ...
                case 5:
                    result = _e.sent();
                    console.log("\u56DE\u586B\u5B8C\u6210\uFF1A\u5339\u914D " + targets.length + " \u6761\uFF0C\u5B9E\u9645\u66F4\u65B0 " + result.modifiedCount + " \u6761\u3002");
                    return [4 /*yield*/, mongoose_1["default"].disconnect()];
                case 6:
                    _e.sent();
                    return [2 /*return*/];
