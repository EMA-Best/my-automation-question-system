...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var host, port, database, uri, dryRun, db, templates, filter, count, res;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, templates.countDocuments(filter)];
                case 2:
                    count = _e.sent();
                ...
                case 3:
                    _e.sent();
                    return [2 /*return*/];
                case 4: return [4 /*yield*/, templates.updateMany(filter, {
                        $unset: {
                            cover: '',
                            category: '',
                            tags: '',
